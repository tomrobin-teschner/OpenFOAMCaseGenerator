...
class Cylinder(CPB.CasePropertiesBase):
    @staticmethod
    def get_properties():
        return {
            'file_properties': {
                ...
                'snappyhexmeshdict': {
                    'snappyhexmesh_directory': os.path.join('examples', 'mesh', ''),
                    'blockmeshdict_directory': os.path.join('examples', 'mesh', ''),
                ...
                # files)
                'polymesh_directory': os.path.join('examples', 'mesh', 'cylinder'),
            ...
            'flow_properties': {
                ...
                'custom_initial_conditions_setup': {
                    'variable': os.path.join('examples', 'scripts', 'initialConditions', 'cylinder', 'U'),
                },
            ...
            'cutting_planes': {
                ...
                # generated)
                'output_cutting_plane_at_every_timestep': True,
            },
