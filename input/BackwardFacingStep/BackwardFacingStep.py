...
class BackwardFacingStep(CPB.CasePropertiesBase):
    @staticmethod
    def get_properties():
        return {
            'file_properties': {
                ...
                # files)
                'polymesh_directory': os.path.join('examples', 'mesh', 'backwardFacingStep', 'coarse'),
            ...
            'boundary_properties': {
                ...
                'boundary_conditions': {
                    ...
                    'pre_inlet_bottom': Parameters.SYMMETRY,
                    'pre_inlet_top': Parameters.SYMMETRY,
                    'post_inlet_bottom': Parameters.WALL,
                    'post_inlet_top': Parameters.WALL,
                    'bottom_wall': Parameters.WALL,
                ...
                'custom_inlet_boundary_conditions_setup': {
                    'U': os.path.join('examples', 'scripts', 'boundaryConditions', 'backwardFacingStep',
