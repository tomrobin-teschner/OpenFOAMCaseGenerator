...
class CheckCase:
    def __init__(self, boundary_properties, solver_properties, turbulence_properties):
    ...
    def check_correct_turbulence_model_setup(self):
        ...
        if (self.solver_properties['solver'] == Parameters.simpleFoam and
                self.turbulence_properties['turbulence_type'] == Parameters.LES):
            sys.exit('\n===================================== ERROR =====================================\n' +
    ...
    def check_correct_boundary_condition_setup(self):
        if self.solver_properties['solver'] == Parameters.simpleFoam:
            ...
            for boundary in self.boundary_properties:
                if self.boundary_properties[boundary] == Parameters.ADVECTIVE_OUTLET:
    ...
    def check_appropriate_numerical_scheme_combination(self):
        if (self.solver_properties['numerical_schemes_correction'] != Parameters.ACCURACY and
                self.turbulence_properties['turbulence_type'] == Parameters.LES):
            warnings.showwarning(
                '\n==================================== WARNING ====================================\n' +
