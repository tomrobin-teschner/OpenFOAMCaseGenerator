...
class fvSchemesFile:
    ...
    def __write_div_schemes(self, file_id):
        ...
        use_first_order = self.properties['numerical_discretisation']['use_first_order_for_turbulence']
        discretisation_policy = self.properties['numerical_discretisation']['numerical_schemes_correction']
