class WriteCuttingPlanes:
    ...
    def write_cutting_planes(self):
        ...
        for line in self.properties['cuttingPlanes']['location']:
            ...
            self.file_manager.write(file_id, '\n')
            if self.properties['cuttingPlanes']['output_cutting_plane_at_every_timestep']:
            ...
            self.file_manager.write(file_id, '    (\n')
            for variable in self.properties['cuttingPlanes']['variables_to_monitor']:
