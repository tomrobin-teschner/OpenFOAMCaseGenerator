...
def test_all():
    ...
    current_test_number = test_backward_facing_step(test_path, current_test_number)
...
def test_naca_0012(test_path, current_test_number):
    ...
    print('Testing --input=Naca0012 ......................................................................... ', end='')
    base_test = ['python', 'OpenFOAMCaseGenerator.py', '--input=Naca0012', run_directory]
    subprocess.run(base_test, shell=True, check=True, stdout=subprocess.DEVNULL)
    print('\033[92mDONE\033[0m')
    current_test_number += 1

    print('\033[94m[' + str(current_test_number) + '/' + str(number_of_tests) + ']\033[0m ', end='')
    print('Testing --input=Naca0012 --replace=flow_properties/flow_type:0 ................................... ', end='')
    modified_test_1 = base_test + ['--replace=flow_properties/flow_type:0']
    subprocess.run(modified_test_1, shell=True, check=True, stdout=subprocess.DEVNULL)
    print('\033[92mDONE\033[0m')
    current_test_number += 1
...
def test_taylor_green_vortex(test_path, current_test_number):
    ...
    print('\033[94m[' + str(current_test_number) + '/' + str(number_of_tests) + ']\033[0m ', end='')
    print('Testing --input=TaylorGreenVortex ................................................................ ', end='')
    base_test = ['python', 'OpenFOAMCaseGenerator.py', '--input=TaylorGreenVortex', run_directory]
    subprocess.run(base_test, shell=True, check=True, stdout=subprocess.DEVNULL)
    print('\033[92mDONE\033[0m')
    current_test_number += 1
...
def test_wing_and_winglet(test_path, current_test_number):
    ...
    print('\033[94m[' + str(current_test_number) + '/' + str(number_of_tests) + ']\033[0m ', end='')
    print('Testing --input=WingAndWinglet ................................................................... ', end='')
    base_test = ['python', 'OpenFOAMCaseGenerator.py', '--input=WingAndWinglet', run_directory]
    subprocess.run(base_test, shell=True, check=True, stdout=subprocess.DEVNULL)
    print('\033[92mDONE\033[0m')
    current_test_number += 1
...
def test_backward_facing_step(test_path, current_test_number):
    run_directory = '--replace=file_properties/run_directory:' + test_path

    print('\033[94m[' + str(current_test_number) + '/' + str(number_of_tests) + ']\033[0m ', end='')
    print('Testing --input=BackwardFacingStep ............................................................... ', end='')
    base_test = ['python', 'OpenFOAMCaseGenerator.py', '--input=BackwardFacingStep', run_directory]
    subprocess.run(base_test, shell=True, check=True, stdout=subprocess.DEVNULL)
    print('\033[92mDONE\033[0m')
    current_test_number += 1
